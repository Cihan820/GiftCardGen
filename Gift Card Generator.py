...
os.system('cls')
print("                          Gift Card Generator By Cihan820")
print("Visit My Website: https://sites.google.com/view/cihan820/")
print("")
print("")
total = input("Enter The Amount Of Gift Cards U Want To Generate: ")
#Number To Generate
number = int(total)
file = (total + " Gift Cards Generated By DuckGen.txt")
file2 = 'GiftCardsCodes.txt'
mode = input("Select The Type Of Gift Card That You Want To Generate :)\nAmazon\nRoblox\nWebkinz\nFortnite\nIMVU\nEbay\nNetflix\niTunes\nPaypal\nVisa\nPokemonTGC\nPlaystation\nSteam\nXbox\nPlayStore\nMinecraft\n")
#Minecraft
if(mode == "Minecraft"):
